...
## Review Questions from Module One Handbook?
 - what can we `typeof` ? strings, numbers, booleans,
 - what can't we `typeof` ? complex datatypes
 - how do we check those things? isInstanceOf
 - Array.isArray() //checks whether it is an array, returns a boolean
 - null === null 
