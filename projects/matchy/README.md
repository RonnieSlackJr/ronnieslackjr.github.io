...
## Step 4 - Review
 1. [x] What are the different ways you can access properties on objects?  //object.key or object["key"];
 2. [x] What are the different ways of accessing elements on  arrays?  // array[index];
